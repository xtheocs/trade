...
Self-improvement feedback loop for the pre-market routine. Each pre-market run scores
**yesterday's** research against yesterday's **actual** results (top tradeable
gainers/losers from Alpaca), names the best trade it realistically could have proposed,
and distills lessons. The pre-market routine reads the last ~7 scorecards to softly bias
today's focus toward recurring winning sectors and away from repeated-miss patterns.

Soft bias only — these lessons NEVER override hard rules (3% risk, quant ≥3/5, 12% heat,
position/sleeve caps, regime gate). Newest entry on top.

Filtered/tradeable universe = price ≥ $5, no warrants/units/rights.
...
**Our picks:**
- SMH (semis ETF) — decision **traded** (entry $646.66) — actual 1d **−4.86%** (Jun-16 close $616.23 vs $647.72) — verdict **hurt, not stopped** (held above $586.01 stop; bought into semi strength the morning of a binary, downside-skewed FOMC).

**Day's top tradeable gainers (Jun-17, ≥$5, no warrants):**
- QURE +78% ($48.17) — biotech / gene-therapy (binary clinical event)
- SDOT +98% ($17.18) — microcap spike
- ALOT +70% ($28.35) — small-cap, no broad catalyst
- JLHL +39% ($33.40) — microcap
- BIRD +39% ($5.48) — Allbirds, small-cap
- (broad-market: AMAT +9.3% early — semi-equipment, same theme as SMH, faded into the hawkish Fed)

**Best realistic miss:** none of quality. Headline gainers were microcap/biotech binary spikes (QURE +78%, ICCM +200%) outside our universe; we correctly skip those. AMAT was the only liquid mover but is the same tech/semi theme we already hold and it faded post-FOMC — not a clean diversified add.

**Lessons:**
- Entering a tech/semi name the morning of a binary, downside-skewed FOMC was poor timing — the 4/5 (volume✗) was the tell; momentum into a known binary with hawkish risk = wait, don't chase.
- Hawkish Fed (dot plot → 2026 hike, 10yr ~4.40%) is a structural headwind for tech/semis — exactly SMH's exposure; do not add to the theme into Thu PCE.
- Day's leaders were junk spikes — liquidity rule worked; no quality swing setup was missed.

**Rolling 7d:** recurring leading sectors = semis/tech (now under Fed/rate pressure), biotech binaries (avoid) ; recurring miss pattern = microcap gap spikes (QURE, ICCM, CAST, SLBT) we correctly skip — no edge there.
