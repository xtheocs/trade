...
### Account
- Equity: $100,000
- Cash: $100,000 (100% — no positions)
- Buying power: $400,000 (4× margin, not using margin)
- Open positions: 0
- Trades this week: 0 (max 3 allowed)
- Daytrade count: 0

### Market Context
- WTI: ~$83.70 (Jul CME -4.57% — sharp energy drop, sector headwind)
- Brent: ~$101 early June; likely pulling back with WTI
- S&P 500 futures: ~7,436 (+0.51%) — positive open expected Monday
- VIX: not available in premarket sources; implied caution given FOMC Wednesday
- Earnings before open Mon June 15: none major scheduled
- Economic calendar: **FOMC June 17 (Wednesday) — key risk event; Fed rate-hike bets elevated after strong June 5 jobs report; next CPI July 14; no CPI/PPI/jobs today**
- Sector momentum:
  - Leading (YTD): Info Tech (+52% trailing 12m), Energy (+50%+), Communication Services (+44%), Industrials (+13.1% per Schwab 6m)
  - Lagging (6m): Health Care (-4.5%), Financials (-1.0%), Consumer Staples, Real Estate
  - This week: Tech and Industrials leading; market flat-to-negative for June month overall
  - AI semiconductor sector: recovering from June 6 $1.4T selloff (SOXX -10% in one session); strong rebound underway

### Macro Themes Active
- **AI Infrastructure:** $700B hyperscaler capex in 2026; HBM memory sold out; WFE spending $140B (+27% YoY); optical fiber/laser shortages; SOXX recovering from June 6 crash — up-cycle intact
- **Defense:** US defense budget >$1T (+15% FY2026); Columbia-class submarine contract ($17.67B to GD Electric Boat); AN/SPY-6 radar ($515M to Raytheon); backlog growing
- **Reshoring:** 95% of US industrial orgs plan automation additions next 3 years; CHIPS Act fab buildout continuing; tariff pressure accelerating onshoring
- **Energy:** WTI -4.57% on Monday futures — Strait of Hormuz disruption partially easing; EIA warns supply to outpace demand later in 2026 → AVOID energy trades

### Candidates by Strategy

**MU (Micron Technology) — AI Infrastructure [Memory]**
- Filters: [sector rotation: Info Tech leading YTD ✓] [macro: AI infrastructure, HBM up-cycle ✓] [catalyst: HBM sold out, DRAM/NAND prices ripping, +7% surge June 3, CEO guides 20% bit growth ✓]
- All 3 filters pass
- Entry: ~$226 | Stop: ~$203 (-10%) | Target: ~$271 (+20%) | R:R 2.2:1 | Position: $25,000 (~110 shares)
- Thesis: AI memory demand overwhelming supply; HBM is the bottleneck for AI clusters; SK Hynix 4 months ahead of schedule still can't fill demand — price cycle extended.

**GD (General Dynamics) — Defense & Reshoring**
- Filters: [sector rotation: Industrials +13.1% Schwab 6m, sector favoured ✓] [macro: US defense >$1T, shipbuilding shortage ✓] [catalyst: Columbia-class SSBN $17.67B contract mod (Electric Boat); backlog through December 2031 ✓]
- All 3 filters pass
- Entry: ~$315 (estimate; confirm at open) | Stop: ~$283 (-10%) | Target: ~$378 (+20%) | R:R 2.2:1 | Position: $25,000 (~79 shares)
- Thesis: Columbia submarine is a 10-year backlog program; US shipbuilding shortage acute; defense budget historic highs with bipartisan support.

**LRCX (Lam Research) — AI Infrastructure [Equipment]**
- Filters: [sector rotation: Info Tech leading ✓] [macro: WFE $140B in 2026 +27% YoY; AI capex driving advanced logic and memory node demand ✓] [catalyst: "Fab 5" seeing record orders; 34% of revenue from memory equipment — direct HBM beneficiary; M&A consolidation signals cycle longevity through 2027-28 ✓]
- All 3 filters pass
- Entry: at market | Stop: -10% from fill | Target: +20% from fill | R:R ~2:1 | Position: $25,000
- Thesis: Wafer fab equipment is the pick-and-shovel play on AI; Lam is the primary beneficiary of 3D NAND/HBM scaling; equipment cycle extending into 2027.

### Held Positions Update
- None.

### Risk Factors
- **FOMC June 17 (Wednesday):** Hawkish surprise could pressure rate-sensitive growth names; June 5 jobs report beat has markets pricing rate hike risk. Positions entered Monday could face headwind mid-week.
- **AI semiconductor fragility:** SOXX just crashed 10% on June 6; sector is in recovery mode. Momentum intact but requires confirmation at open.
- **Oil sharp drop (-4.57%):** Energy sector will be under pressure Monday — no energy positions planned.
- **Market flat for June:** Broader market soft since May end; S&P futures positive but underlying breadth weak.
- **Position #3 (LRCX) FOMC sensitivity:** If market shows pre-FOMC caution Monday, may skip LRCX and add post-Wednesday.

### Decision
**TRADE: MU, GD, LRCX**
- 3 trades → $75,000 deployed = 75% of equity (minimum target)
- Max 2 per bucket: AI Infrastructure (MU + LRCX), Defense (GD alone in bucket)
...
## 2026-07-09 — Pre-market (Thu Jul 9; for today's open)

**Account:** equity $1,068.31 / cash $1,068.31 (100%) / drawdown-from-peak −1.90% (peak $1,089.01) / 0 open positions / 0 week trades (3 free). Breaker inactive.

**Regime:** equity **risk_on** — SPY 745.28 above its rising 50d ($739.60). But the tape is defensive/soft: Perplexity flags futures down >1% and a fresh tech/semi rout on AI-capex-slowdown fears (chip sector ~10% below peak), plus banks pressured by higher energy prices/credit worries. Risk_on by the letter; internals a defensive rotation with tech broken.

**Leading sectors:** Health Care the weekly leader (+3.16%); Consumer Discretionary/Real Estate firm. Industrials now the week's **laggard** (−1.53%) — a reversal of the H1 lead. Info Tech/semis broken (~10% below peak). On the tape the confirmers are still the defensive/value ETFs (XLP/XLI/XLV/XLF), but all fail the setup filter (below).

**Macro:** **CPI DATE CORRECTION** — June CPI prints **Tue Jul 14** at 8:30 ET (BLS schedule), *not* Fri Jul 10 as prior logs assumed. The binary is 5 days out, so today's stay-out case rests on setup quality, not an imminent print. Next FOMC Jul 29 (hold expected; Dec cut in play). Tape soft on tech/energy-credit today.

**Candidates (passed catalyst + quant, but failed setup filters):** None opened.
- XLF (ETF, Financials) — catalyst: value rotation, but weakening (banks led yesterday's selloff on energy/credit) — quant **5/5 confirmed** (trend✓ momentum✓ rel_strength✓ volume✓ 1.24× not_extended✓; last $54.97, sma20 $53.97, ret_10d +2.06%, ATR $0.79, risk/sh $1.59, stop $53.38, 20d high $56.58) — **REJECTED: R:R fails 2:1 + catalyst deteriorating.** The cleanest chart on the board and the pullback-to-20d we were watching for (tightest stop, $1.59 risk/sh), but the 20d high is only ~1R away while a 2R objective = $58.15 (+5.8%) sits *above* resistance in unproven breakout air — and banks are now leading the tape *down*, not up. Closest-to-tradeable; watch for a $56.58 break with real room.
- XLP (ETF, Consumer Staples) — catalyst: defensive/value rotation — quant **3/5 confirmed** (trend✓ momentum✓ rel_strength✗ volume✗ 0.87× not_extended✓; last $84.41, sma20 $84.34, ret_10d +0.85%, ATR $1.33, risk/sh $2.67, stop $81.74, 20d high $86.35) — **REJECTED: R:R fails 2:1.** Right on the 20d but weak momentum (+0.85% 10d); 2R objective = $89.75 (+6.3%) is unrealistic air for a slow staples ETF. Ground −0.51% yesterday.
- XLI (ETF, Industrials) — catalyst: value/capex rotation, but sector faded to week's laggard — quant **3/5 confirmed** (trend✓ momentum✓ rel_strength✗ volume✗ 0.66× not_extended✓; last $180.42, sma20 $180.24, ret_10d +1.28%, ATR $3.40, risk/sh $6.79, stop $173.63, 20d high $186.44) — **REJECTED: R:R fails 2:1 + weakening sector.** Faded a second straight session onto the 20d; 2R objective = $194.01 (+7.5%) is unrealistic air, and Industrials just went from H1 leader to weekly laggard.
- XLV (ETF, Health Care) — catalyst: defensive rotation + weekly sector leader (+3.16%) — quant **3/5 confirmed** (trend✓ momentum✓ rel_strength✓ volume✗ 0.85× not_extended✗ — extended >2ATR above 20d; last $162.30, sma20 $156.22, ret_10d +6.69%, risk/sh $5.70, stop $156.60, 20d high $165.60) — **REJECTED: over-extended + R:R fails 2:1.** Faded −1.34% off the 20d-high chase; ~2% under its high (~0.58R room), 2R objective = $173.70 (+7.0%) needs an unrealistic breakout while stretched >2ATR above the 20d. Want a pullback to the rising 20d ($156).

**Rejected (other):**
- PENG (stock, AI memory/infra) — huge real catalyst (record Q3 rev +48%, EPS $0.84 vs $0.55; FY rev-growth guide doubled 12%→22%; PT raises to $65-66) and quant **5/5** — but it gapped +19-25% straight to a fresh 52-week high with an $8.67 ATR (−22% stop); the not_extended check passes only because a +270%-YTD parabola drags the 20d SMA up under price. A blow-off earnings gap — the exact chase the rule filters; a 2R target = +44% is fantasy and gap-and-fade risk is severe (fractional = no overnight stop). Skip the chase; watch for a base.
- Semis/tech (SMH/MU/INTC/NVDA) — below a falling 20d, quant broken, renewed AI-capex-slowdown pressure. No base.
- Movers screen (NVVE/BKYI/TVRD/WULX + warrants) — microcap/thin spikes; fail liquidity, not swing setups. Skip per repeated lessons.
- Inverse sleeve (SQQQ/SH) — regime risk_on (SPY > rising 50d); not sanctioned despite the tech wobble.
...
### Regime
- Equity: **RISK_ON** (SPY $772.54 > 50-day SMA $748.08, rising). New long equity allowed at full size; inverse sleeve not sanctioned.

### Market Context
- **July CPI (in-line/soft) eased Fed-hike fears** — tech/semis rallied Aug-12 (NVDA +3%, Nasdaq led, VIX fell). Constructive risk_on tape.
- **PPI (July) + Retail Sales land tomorrow, Fri Aug-14, 8:30 ET** — the week's remaining macro binary; a new position opened today would be held into it.
- Leading sectors (weekly, Alpaca-corroborated): **Info Tech / Semis (XLK +1.59% wk, SMH +2.08%, NVDA +3%), Energy (XLE, +40%+ YTD), Health Care (XLV +2.6% wk).** Laggards: Consumer Discretionary, Comm Services.

### Candidates (catalyst + quant confirmed)
- **XLK** (ETF, Tech) — catalyst: tech/semis leadership + soft CPI — quant **4/5** (fails volume 0.73×; last $188.88, sma20 $179.61 rising, ret_10d +13.4%, ATR $5.22, risk/sh $10.43, stop $178.45, hi_20d $189.58, rs +7.5%) — **rejected**: closed above its $188.82 20d high (day-1 breakout, not yet held/retested); 2R target ~$209.8 (+11%) in open air with no anchored objective; PPI binary tomorrow. Best watch name — a held breakout above $188.82 with a retest = clean buy.
- **AVGO** (stock, semis/AI) — catalyst: AI-chip momentum — quant **4/5** (fails volume; last $415.87, sma20 $396.20 rising, ret_10d +12.3%, ATR $15.67, risk/sh $31.35, stop $384.52, hi_20d $432.66, rs +6.4%) — **rejected**: 1.08R under its high, pinned; 2R target ~$479 in air → fails 2:1.
- **NVDA** (stock, semis/AI) — catalyst: AI-chip momentum + soft CPI — quant **3/5** (fails volume + not_extended; last $224.11, sma20 $208.39 rising, ret_10d +17.9%, ATR $7.77, risk/sh $15.53, stop $208.58, hi_20d $225.10, rs +12%) — **rejected**: still 0.06R under its high, at all-time-high territory; 2R target ~$255 (+14%) blue-sky; ran +3.06% Aug-12 — the run we passed on.
- **XLE** (ETF, Energy) — catalyst: energy leadership — quant **3/5** (fails rel_strength + volume; last $61.02, sma20 $58.74 rising, ret_10d +4.1%, ATR $1.42, risk/sh $2.83, stop $58.19, hi_20d $61.17, rs −1.8%) — **rejected**: lags SPY (rs false), momentum stalled +0.18% Aug-12; 2R target ~$66.7 in air → fails 2:1.

### Rejected
- NVDA / AVGO — confirmed but pinned/at their 20d highs → 2R target in blue-sky air → fails 2:1.
- XLK — first confirmed breakout close (above $188.82) but day-1, not held/retested, 2R in open air, PPI binary tomorrow → deferred to a held-breakout entry.
- XLE — 3/5, lagging SPY (rs false), momentum stalled.
- SMH 3/5 (trend false — below a non-rising 20d SMA) — not a clean trend.
- Movers (BOXL micro +169%; NEBX/NBIL/NBIG/NBIC/CRWX/CRWG/CWVX/SMCC leveraged single-stock ETNs +38–69%) — un-tradeable, decaying products / fail not_extended.
- Inverse sleeve (SQQQ/SH/SPXU) — regime risk_on, not sanctioned.
