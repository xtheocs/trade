...
### Sep 15 — Midday Scan: Stop Trailed
**Positions:** 1 — XLE 4 sh @ $62.15, now $65.855 (+5.96%). 1 order live.
**Action:** No losers (sole position well in the green, not near −7%). No thesis break (oil spike tailwind intact, quant still 4/5: trend/momentum/rel_strength/not_extended true, volume 0.78× false). XLE up +2.9×ATR from entry (entry $62.15, last $65.855, ATR14 $1.2686). Trail: new stop = max(current $62.99, last−2×ATR $63.32, 10d-low ~$61.3) = **$63.32**. Cancelled prior GTC stop (dcfd369d @ $62.99), placed new GTC stop @ $63.32 (order d0828e1d). New stop is 3.85% below live price — outside the 3%-no-touch band; never moved down. No time-stop concern (position ~4 weeks old, trending in favor, gains locked well above breakeven).
**Account:** Equity $1,083.34 | Cash $819.70 | Peak $1,089.01 | DD −0.52% | Breaker inactive.
**Positions:** 1/4 (XLE) · Heat = locked-in gain, not risk (stop above entry). Weekly trades: 0/3.
